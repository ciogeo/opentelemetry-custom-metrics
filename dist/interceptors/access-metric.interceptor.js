...
let AccessMetricInterceptor = class AccessMetricInterceptor {
    constructor(name) {
        const metricsService = new metrics_1.Metrics();
        this.accessCounter = metricsService.addInstrumentation(metric_type_1.MetricType.COUNTER, `${name}_counter`);
    }
...
//# sourceMappingURL=access-metric.interceptor.js.map